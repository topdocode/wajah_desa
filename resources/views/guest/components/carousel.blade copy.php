                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item="{{ $index == 00 ? 'active' : null }}">
                    ...
                    <div class="absolute block w-full h-full bg-cover  "
                        ...
                        <div
                            ...
                            <div>
                                <div class="md:mb-4">
                                    <h1 class="font-bold bg-primary inline md:text-4xl">{{ $item->heading }}</h1>
                                </div>
                                <div class="md:mb-4">
                                    <h1 class="font-bold bg-primary inline md:text-4xl">{{ $item->title }}</h1>
                                </div>
                                <div class="md:mb-4">
                                    <h2 class="font-bold bg-primary inline md:text-4xl">{{ $item->info }}
                                    </h2>
                                </div>
                            </div>
                        </div>
        ...
        @if ($lengthCarousel < 2)
            @for ($item = 1; $item <= ($lengthCarousel == 0 ? 2 : 1); $item++)
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ asset('assets/images/carousel/carousel-1.jpeg') }}"
